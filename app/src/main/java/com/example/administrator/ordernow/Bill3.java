...
public class Bill3 implements Serializable {
    @SerializedName("ID")
    private int ID;
    ...
    public Bill3(int ID, int ID_USER, String NAME_BILL, String ID_TABLE, String ID_FOOD, int ID_VOUCHER, int ID_CUSTOMER, int ID_CREATED, String NOTE, int TOTAL_PRICE, int STATUS, String TIME_CREATED) {
        this.ID = ID;
